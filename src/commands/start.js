...
export default function register(bot) {
  bot.command("start", async (ctx) => {
    ...
    await ctx.reply([
      "Pocket Signal helps you read live real-market charts across forex, crypto, commodities, and indices when your market-data provider supports them.",
      "Use /chart BTCUSD 5m, /market EURUSD 1h, or /signal XAUUSD 15m. Supported timeframes: 1m, 5m, 15m, 1h, 4h, 1d.",
